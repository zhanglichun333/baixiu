  ...
  <div class="aside">
    ...
    <ul class="nav">
      ...
      <li <?php echo in_array($current_page,$menu_posts)?'class="active"':''; ?>>
        <a href="/admin/#menu-posts" class="<?php echo in_array($current_page,$menu_posts)?'':'collapsed'; ?>" data-toggle="collapse">
      ...
      <li class="<?php echo in_array($current_page,$menu_settings)?'active':''; ?>">
        <a href="/admin/#menu-settings" class="<?php echo in_array($current_page,$menu_settings)?'':'collapsed'; ?>" data-toggle="collapse">
      ...
      <li class="<?php echo $current_page==='doupan'?'active':''; ?>">
        <a href="/admin/doupan.php"><i class="fa fa-list-ol"></i>电影榜单</a>
      </li>
    </ul>
  </div>
