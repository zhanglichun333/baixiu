...
$posts_count_drafted=bx_fetch_one("select count(1) as num from posts where status='drafted';")['num'];
...
$comments_count_held=bx_fetch_one("select count(1) as num from comments where status='held';")['num'];
 ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
        ...
        <div class="col-md-4">
          <div class="panel panel-default">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item"><strong><?php echo $comments_count ?><?php echo $comments_count_held ?></strong>条评论（<strong>1</strong>条待审核）</li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
